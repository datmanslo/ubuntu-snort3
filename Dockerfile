ARG BUILDER_BASE=xiche/ubuntu-snort3-dev
...
# OpenAppID version can change in the future (16584)
ARG ODP_URL=https://snort.org/downloads/openappid/16584

# Add google-perftools for tcmalloc
RUN apt-get update && apt-get install -y libgoogle-perftools-dev wget \
